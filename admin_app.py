...
@app.route('/theme-backgrounds/upload', methods=['POST'])
@login_required
...
@app.route('/theme-backgrounds/get')
@login_required
...
@app.route('/theme-backgrounds/clear-theme', methods=['POST'])
@login_required
